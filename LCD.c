...
void LCD_init (void){
	...
	DIO_DDRA = 0xFF;
	//_delay_us(50);
	Timer_enmDelayBlocking(TIMER_GENERAL_DELAY, TIMER_PERIOD_10_MICRO_SECOND, 5);
...
void LCD_sendCommand(uint8_t command){
	...
	DIO_WritePin(Register_Select,DIO_LEVEL_LOW);  /* Select instruction register */
	DIO_WritePin(Read_Write,DIO_LEVEL_LOW);		/* Write operation */
	DIO_WritePin(Enable_LCD,DIO_LEVEL_HIGH);		/* Enable Signal */
	//_delay_us(50);
	Timer_enmDelayBlocking(TIMER_GENERAL_DELAY, TIMER_PERIOD_10_MICRO_SECOND, 5);
	...
	//_delay_us(50);
	Timer_enmDelayBlocking(TIMER_GENERAL_DELAY, TIMER_PERIOD_10_MICRO_SECOND, 5);
	DIO_WritePin(Enable_LCD,DIO_LEVEL_LOW);       /* Disable Signal */
	//_delay_us(50);
	Timer_enmDelayBlocking(TIMER_GENERAL_DELAY, TIMER_PERIOD_10_MICRO_SECOND, 5);
	DIO_WritePin(Enable_LCD,DIO_LEVEL_HIGH);		/* Enable Signal */
	//_delay_us(50);
...
void LCD_displayChar(uint8_t character){
	/* Control Signals Configuration */
	DIO_WritePin(Register_Select,DIO_LEVEL_HIGH);  /* Select data register */
	DIO_WritePin(Read_Write,DIO_LEVEL_LOW);		/* Write operation */
	DIO_WritePin(Enable_LCD,DIO_LEVEL_HIGH);		/* Enable Signal */
	//_delay_us(50);
	Timer_enmDelayBlocking(TIMER_GENERAL_DELAY, TIMER_PERIOD_10_MICRO_SECOND, 5);
